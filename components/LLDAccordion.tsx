...
import { LLDAccordionProps } from "@/constants/lld/questions/data";

export default function LLDAccordion({ items }: LLDAccordionProps) {
  return (
    <div className="w-full">
      <Accordion type="single" collapsible className="w-full">
        {items.map((item) => (
          <div
            key={item.id}
            className="p-4 shadow-md shadow-muted-foreground font-mono rounded-md mb-4 hover:bg-pink-200 hover:scale-110 duration-300 transition"
          >
